...
export default observer(class CreateLobbyView extends React.Component {
  state = {
    title: "",
    desc: "",
    currentVideoId: ""
  ...
  onSubmit(event) {
    ...
    model.lobby.createLobby(this.state.title, this.state.desc, this.state.currentVideoId)
      .then((lobby) => {
